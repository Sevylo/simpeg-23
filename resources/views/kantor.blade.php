...
<body class="overflow-auto">
    <h1 class="text-center text-primary fw-bolder fst-italic mt-2">Tabel Kantor</h1>
  <br>
    <div class="container text-left">
      <div class="row row-cols">
        <div class="col gx-5">
          <a class="btn btn-md btn-primary rounded-pill text-light" href="kantor/tambahkantor" role="button">Tambah Data</a>
        </div>
      </div>
    </div>
  ...
  <div class="row float-end">
    <div class="col gx-5">
      <a class="btn btn-md btn-primary rounded-pill text-light" href="/exportpdf6" role="button">Export PDF</a>
    </div>
  </div>
</div>
...
<a href="/editkantor/{{$row->id_kantor}}" class="btn btn-xs btn-success text-light">Edit</a> 
<a href="#" class="btn btn-xs btn-danger delete" data-id="{{$row->id_kantor}}">Delete</a>
</td>
</tr>
@endforeach
</tbody>
...
<script>
  ...
  text: "Anda akan menghapus data pegawai dengan Id Kantor "+pegawaiid+"",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
.then((willDelete) => {
  if (willDelete) {
    window.location = "/kantor/destroy/"+pegawaiid+""
